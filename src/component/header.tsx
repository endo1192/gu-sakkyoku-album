...
function Cheader() {
  ...
  const handleMenuOpen = () => {
    ...
    return (
        <Sheader>
          <Sleft>
            <Link href="/"><Image src="/sakkyokukyara.png" alt="Description of the image" width={1280} height={1280} style={{ width: "30%", height: "auto" }}/></Link>
          </Sleft>

          <SImage>
          <Link href="/"><Image src="/sakkyokukyara.png" alt="Description of the image" width={1280} height={1280} style={{ width: "50%", height: "auto" }}/></Link>
          <h1 className="text-blue-900">群馬大学作曲部</h1>
            ...
            <Sbutton onClick={handleMenuOpen} type="button" className="z-10 space-y-2">
            <div
              className={
                openMenu
          ...
          >
            <ul className="mt-6">
              <li className="">
                <Link href="/Horoscope" className="py-2 inline-block">
                  Horoscope
                </Link>
              </li>
              <li className="">
                <Link href="/Niijiro" className="py-2 inline-block">
                  虹色memory
                </Link>
              </li>
              <li className="">
                <Link href="/" className="py-2 inline-block">
                  トップページ
                </Link>
              </li>
            </ul>
